...
Rayo Pixel::generarRayoMitad(Punto3D porigen) {
    return Rayo(porigen, Punto3D(down_right.getx()+((up_left.getx()-down_right.getx())/2), down_right.gety()+((up_left.gety()-down_right.gety())/2), down_right.getz()+((up_left.getz()-down_right.getz())/2)));
}
